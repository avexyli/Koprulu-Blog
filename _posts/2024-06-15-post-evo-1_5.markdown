...
### <img src="{{site.baseurl}}/images/btn-unit-terran-siegetank-vulture@scbw.png" width="50" height="50"> Vulture

- Spider Mines now unburrow instead of acquiring new target if their chased unit dies

### <img src="{{site.baseurl}}/images/btn-unit-terran-siegetank-ghost@scbw.png" width="50" height="50"> Ghost
...
- Reduced Sunken Colony Build time Reduced from 35 -> 18
...
- Fixed Spider mines detonating instantly instead of using their weapon delay when chasing cloaked hidden targets
- Fixed Plague not damaging units inside Nydus Networks
- Fixed Irradiate not damaging its main target inside Nydus Networks, other units loaded into the network will not take damage from this
...
- Removed autocast from Carrier interceptro build & Reaver scarab build
