...
- Fixed Dark Archon mind control being able to target allied units __(Core)__
...
### <img src="{{site.baseurl}}/images/btn-unit-protoss-arbiter.png" width="50" height="50"> Scout
...
- Fixed Arbiter Stasis targeting highlighting SC2 Ultralisks during targeting
