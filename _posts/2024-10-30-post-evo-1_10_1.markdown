...
We have another minor patch that fixes some visual bugs, a valkyrie rework to make them more accurate to BroodWar and some other minor improvements.
...
- Fixed Reaver Scarabs not clearing its targeting on teleports 
