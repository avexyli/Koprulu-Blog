...
#### Please note: these changes are IN ADDITION TO the changes from the first part of the 1.11 PTR.
##### Wherever applicable, initial values for the listed changes are from the first part of the 1.11 PTR.
...
To fix this, we are reverting the Heal range increase. We are also trying to introduce more possibilities surrounding Energy management by hastening the Caduceus Reactor upgrade.

### <img src="{{site.baseurl}}/images/btn-unit-terran-battlecruiser.png" width="50" height="50"> Battlecruiser
...
### <img src="{{site.baseurl}}/images/btn-unit-zerg-hydralisk.png" width="50" height="50"> Hydralisk
- Decreased Hydralisk attack period: 0.938 -> 1.0312
- Sunken Colony attack period: 2 -> 2.125
- Sunken Colony HP: 350 -> 325
- Spore Colony attack range: 8.5 -> 8

In previous patches, BW Zerg received numerous buffs to shore up its earlygame defenses. We think that these changes were highly successful. Even recently, the Hydralisk received a QoL/design rework in the form of a hitscan attack more closely resembling its original counterpart. 

Unfortunately, we think these changes were too effective in hindsight. In particular, they turned the Hydralisk into an overwhelming generalist that is too strong and too easy to use in almost any situation.

BW Zerg earlygame optimization and midgame tech (namely, Spire and Lurkers) have come a long way since the days of the Chzzk Cup. Therefore, we think these changes are warranted to help reintroduce some weakness into the BW Zerg earlygame. In particular, this will also limit the Hydralisk's push potential.

We are aware that the Hydralisk will likely remain one of the most versatile units in the game, and will continue to keep an eye on it as we also look for ways to adjust BW Zerg elsewhere.

{: .note }
In particular, we chose to nerf the attack period and HP of the Sunken Colony because its damage-per-hit and range are essential to defending against Banelings and cannon rushes, respectively.
...
- Scarab Damage upgrade damage bonus: 25 -> 25 (+30 vs Shields)
