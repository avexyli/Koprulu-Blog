...
As this is a PTR, many of these changes are experimental. Please reach out to use in the **#extension-feedback** channel on the Project Koprulu Discord server to share your thoughts on the balance of the changes, as well as whether or not they achieve the goals described herein.
...
These buffs are intended to improve the Devourer's effectiveness, without affecting its identity as a medium-speed, debuffer-tank support unit. In particular, it is now able to survive 2 uses of the SC2 Ghost's Steady Targeting.
