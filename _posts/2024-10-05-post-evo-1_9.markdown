---
layout: post
title:  SC Evo Complete Extension 1.9.3 patch notes
description: Balance Patch and New Models
...
- Added Photon Cannon Model

![]({{site.baseurl}}/images/modelpreview-photoncannon.png)

## Hotfix 1.9.2

- Burrowed Lurker's HP no longer changes while Burrowed

## Hotfix 1.9.1

- Fixed an issue allowing reavers to attack immediately after being unloaded __(Core)__
...
- Increased Zergling Attack Period 0.57 -> 0.58
- Reduced Adrenal Glands Attack Period Reduction 45% -> 40%
